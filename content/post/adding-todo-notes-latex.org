...
Many researchers and programmers have a tendency to add =todo= and =fixme= to their comments to mark stuff to be fixed. Such placeholders are available in \(\rm\LaTeX\) too. 
